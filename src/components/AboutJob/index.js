...
class AboutJob extends Component {
  ...
  getJobData = async () => {
    ...
    if (responseJobData.ok === true) {
      const fetcheJobdData = await responseJobData.json()
      const updatedJobDetailsData = [fetcheJobdData.job_details].map(
        eachItem => ({
      ...
      const updatedSimilarJobDetails = fetcheJobdData.similar_jobs.map(
        eachItem => ({
          companyLogoUrl: eachItem.company_logo_url,
          id: eachItem.id,
          jobDescription: eachItem.job_description,
            ...
            <div className="first-part-container">
              ...
              <div className="location-package-container">
                <div className="location-job-type-container">
                  ...
                  <div className="employment-type-icon-empoloyment-type-container">
